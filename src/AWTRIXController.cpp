...
BlueDot_BME280_TSL2591 BDbme280 = BlueDot_BME280_TSL2591();
BlueDot_BME280_TSL2591 BDtsl2591;
	...
	if (!ignoreServer)
	{
		...
		case 12:
		{
			...
			case TempSensor_BMP280:
				...
				break;
			case TempSensor_BDbme280:
				root["Temp"] = BDbme280.readTempC();
				root["Hum"] = BDbme280.readHumidity();
				root["hPa"] = BDbme280.readPressure();
				Serial.println(BDbme280.readTempC());
				Serial.println(BDbme280.readHumidity());
				Serial.println(BDbme280.readPressure());
				break;
			default:
				root["Temp"] = 0;
				root["Hum"] = 0;
...
{
	delay(2000);
	BDbme280.parameter.I2CAddress = 0x77;
	BDtsl2591.parameter.I2CAddress = 0x29;
	BDbme280.parameter.tempOutsideCelsius = 15;
	BDbme280.parameter.pressureSeaLevel = 1013.25;
	BDbme280.parameter.pressOversampling = 0b101;
	BDbme280.parameter.tempOversampling = 0b101;
	BDbme280.parameter.humidOversampling = 0b101;
	BDbme280.parameter.sensorMode = 0b11;
	BDbme280.parameter.IIRfilter = 0b100;
	BDbme280.parameter.sensorMode = 0b11;
	BDtsl2591.parameter.integration = 0b000;
	BDtsl2591.parameter.gain = 0b01;
	...
	//else if (BDbme280.init_BME280())
	//init() == 0x60)
	//{
		//temp OK daniel
	if (BDbme280.init_BME280() != 0x60) 
	{        
  ...
  {
    Serial.println(F("BD BME280 detected!"));
		BDbme280.parameter.pressureSeaLevel = 1013.25;
		tempState = TempSensor_BDbme280;
		hardwareAnimatedCheck(MsgType_Temp, 29, 2);
	}
